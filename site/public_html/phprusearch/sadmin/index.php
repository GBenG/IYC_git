...
<HTML>
<HEAD>
<TITLE>Администрирование PHPru_Search v.2.6</TITLE>
...
<TR>
	...
	<TD><INPUT TYPE="text" SIZE=30 NAME="domen" VALUE="http://<?=$_SERVER["SERVER_NAME"]?>"></TD>
</TR><TR>
...
?>
	...
	<TABLE WIDTH=400>
	<TR>
		<TD WIDTH=20%>.exe<BR>.dll<BR>.msi<BR>.msp<BR>.fon</TD>
		<TD WIDTH=20%>.ttf<BR>.doc<BR>.xls<BR>.zip<BR>.rar</TD>
		<TD WIDTH=20%>.swf<BR>.gif<BR>.jpg<BR>.png<BR>.bmp</TD>
		<TD WIDTH=20%>.htaccess<BR>.css<BR>.js<BR>.pl<BR>.cgi</TD>
		<TD WIDTH=20%>.psd<BR>.mp3<BR>.avi<BR>.mpeg<BR>.mid</TD>
	</TR>
	</TABLE>
	</TD>
</TR><TR>
...
<CENTER><P>
Добро пожаловать!<BR>
Вы находитесь в панели управления поисковым скриптом <A HREF="http://phpru.net/scripts/">PHPru_Search v.2.6</A><BR><BR>
<TABLE WIDTH=95% BORDER=0 CELLPADDING=0 CELLSPACING=1 BGCOLOR=#444444>
<TBODY BGCOLOR=IVORY>
<TR VALIGN=TOP>
	<TD WIDTH=150>
