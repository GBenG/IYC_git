...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<p align="center"><strong>Ваш личный кабинет</strong></p>
...
{   
 ...
 or (($userdata['user_ip'] !== $_SERVER['REMOTE_ADDR'])  and ($userdata['user_ip'] !== "0")))
    ...
    {
      //  print '<hr><br>Привет, '.$userdata['user_login'].' Ты в системе!<br><hr><br>';
		
		print '<b>Отчет о нашей работе</b><hr><br>';
		print '<b>Стороны по делу:</b> '.$userdata['surname'].'<br><br>';
		print '<b>Предмет спора:</b> '.$userdata['name'].'<br><br>';
		print '<b>Подсудность:</b> '.$userdata['fname'].'<br><br>';
		print '<b>Дата слушания:</b> '.$userdata['dnumber'].'<br><br>';
		print '<b>Проделанная работа:</b> <br><hr>'.$userdata['situation'].'<br><hr>';
    }
}
else
{
