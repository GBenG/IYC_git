...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			...
  			<tr>
				...
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="adress" width="90px"><a href="/online.php">RUS</a><img src="images/flag-rus.jpg" height="50" align="absmiddle"></td>
                    <td class="adress" width="90px"><a href="/online-u.php">UKR</a><img src="images/flag-ukr.jpg" height="50" align="absmiddle"></td>
                    <td>&nbsp;</td>
                  </tr>
                </table></td>
 ...
 <p align="center"><strong>Задайте своє питання прямо зараз</strong> </p>
	          
 <form method="POST">
<table width="100%" border="0" cellspacing="6" cellpadding="0">
  <tr>
    <td width="150">Ваше ПІБ</td>
  ...
  <tr>     </tr>
  <tr>
    <td colspan="2"><input name="submit_q" type="submit" value="Надіслати"></td>
    </tr>
  <tr>
    <td colspan="2"> <hr>* Всі питання проходять попередню перевірку. Після затвердження наші юристи дадуть Вам відповідь в найкоротший терміни, і ваше питання разом з відповіддю буде розміщений на цій сторінці. </td>
  </tr>
</table>
</form>
 </div>
 ...
 <br> 
 <div>
 <p align="center"><strong>Часті питання</strong> </p>
