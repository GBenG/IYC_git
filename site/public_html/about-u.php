...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			...
  			<tr>
				...
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="adress" width="90px"><a href="/about.php">RUS</a><img src="images/flag-rus.jpg" height="50" align="absmiddle"></td>
                    <td class="adress" width="90px"><a href="/about-u.php">UKR</a><img src="images/flag-ukr.jpg" height="50" align="absmiddle"></td>
                    <td>&nbsp;</td>
                  </tr>
                </table></td>
    ...
    <td height="250px" colspan="3"  bgcolor="#dcdcdc" background="images/img__11.gif">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
 			 <tr>
				...
				<table width="100%" height="249px" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="30px">
						...
						<img src="images/img__60u.gif" width="203" height="27" dynsrc="images/img__60u.gif" name="pic1" title="Задать свой вопрос прямо сейчас!">						</a>					</td>
                  </tr>
                  <tr>
                    <td colspan="5">&nbsp;</td>
                  </tr>
                ...
                <div style="position:relative; left:300px; top:70px;"><img src="images/free-u.gif" width="187" height="95"></div>				</td>
				<td>&nbsp;</td>
  ...
  <tr>
	...
	    <strong></strong>Компанія «ІнЮрКомпани» формує та надає якісний, професійно підібраний, комплексний та доступний юридичний продукт для юридичних і фізичних осіб.<br><br>

	    <strong>Якість </strong> - основний принцип діяльності компанії. Зв'яжіться з нами для вирішення Вашої проблеми, і ми визначимо який саме фахівець вам потрібний. Ми зацікавлені в успіху наших клієнтів, і ми сумлінно ставимося до справ та проектів, що доручають нам наші клієнти. Для нас надзвичайно важливим встановлення та підтримання стабільних відносин з клієнтами, що передбачає розуміння потреб клієнта, доведення до клієнта необхідної інформації, здійснення ефективного правового забезпечення та спрямованість на досягнення конкретного результату.<br><br>

	    <strong>Комплексність </strong> - компанія готова надати юридичні послуги, починаючи з утворення підприємства, отримання всіх необхідних дозвільних документів, до системного юридичного супроводу функціонування бізнесу. Ми пропонуємо Вам комплексний підхід при вирішенні Ваших проблем та здійсненні Ваших задумів, що передбачає надання в одному пакеті юридичних, адвокатських, перекладацьких та нотаріальних послуг. <br> <br>

	    <strong>Професіоналізм </strong> - висококваліфіковані фахівці нашої компанії допоможуть Вам вирішити проблеми будь-якої складності. Запорукою нашого успіху є висока кваліфікація наших юристів, досконале знання українського та міжнародного законодавства, творчий підхід і вміння стрімко реагувати на потреби наших клієнтів. <br> <br>

	    <strong>Домінантність </strong> - в процесі своєї діяльності компанія «ІрЮрКомпани» дотримуємося правила домінантності інтересів Клієнта перед своїми власними інтересами, інтересами колег, партнерів та інтересами інших осіб. Здійснює свою професійну діяльність, спираючись на принципи конфіденційності, незалежності, компетентності, сумлінності, гуманізму. <br> <br>

	    <strong>Креативність </strong> - ми вільні від стереотипів. Креативний підхід до кожної справи та кожного проекту для нас - це правило. Разом з тим, ми не чекаємо поки у наших клієнтів виникнуть проблеми в сфері правозастосування, ми робимо все для того, щоб не допустити їх виникнення. <br> <br>

	    <strong></strong>Ми досвідчені, ми амбітні і ми знаємо, що необхідно нашим клієнтам: позитивний результат та впевненість у своїй правовій позиції. І ми знаємо, як цього досягти.
