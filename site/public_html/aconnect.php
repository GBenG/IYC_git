...
if(isset($_POST['submit']))
{
    ...
    else
    {
     //  print "Вы ввели неправильный логин/пароль";
	   header("Location: nopass2.html"); exit();
    }
}
?>
<html>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<p align="center"><strong>Доступ в панель администратора</strong></p>
...
<form method="POST">
    <table align="center">
        <tr>
          <td rowspan="4"><img src="images/aioka.jpg" width="50" height="61"></td>
            <td rowspan="4">&nbsp;</td>
            <td>Логин:</td>
