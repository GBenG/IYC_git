  			...
  			<tr>
				...
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="adress" width="90px"><a href="/report.php">RUS</a><img src="images/flag-rus.jpg" height="50" align="absmiddle"></td>
                    <td class="adress" width="90px"><a href="/report-u.php">UKR</a><img src="images/flag-ukr.jpg" height="50" align="absmiddle"></td>
                    <td>&nbsp;</td>
                  </tr>
                </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="middlemenu">
          <tr>
            ...
            <td><a href="fiz-u.php">Фізичні особи</a></td>
			<td width="1px"  background="images/img__59.gif">&nbsp;</td>
 ...
 or (($userdata['user_ip'] !== $_SERVER['REMOTE_ADDR'])  and ($userdata['user_ip'] !== "0")))
    {
        ...
        print "Хм, щось не вийшло";
    }
    else
    {
      //  print '<hr><br>Привет, '.$userdata['user_login'].' Ты в системе!<br><hr><br>';
		
		print '<b>Звіт про нашу роботу</b><hr><br>';
		print '<b>Сторони у справі:</b> '.$userdata['surname'].'<br><br>';
		print '<b>Предмет спору:</b> '.$userdata['name'].'<br><br>';
		print '<b>Підсудність:</b> '.$userdata['fname'].'<br><br>';
		print '<b>Дата слухання:</b> '.$userdata['dnumber'].'<br><br>';
		print '<b>Виконана робота:</b> <br><hr>'.$userdata['situation'].'<br><hr>';
    }
}
else
{
