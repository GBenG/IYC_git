...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  			...
  			<tr>
				...
				<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="adress" width="90px"><a href="/contacts.php">RUS</a><img src="images/flag-rus.jpg" height="50" align="absmiddle"></td>
                    <td class="adress" width="90px"><a href="/contacts-u.php">UKR</a><img src="images/flag-ukr.jpg" height="50" align="absmiddle"></td>
                    <td>&nbsp;</td>
                  </tr>
                </table></td>
  ...
  <tr>
	...
	<p align="center"><strong>Наші контакти</strong></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="content">
  ...
  <tr>
    ...
    <td style="padding-left:10px; font-weight:bold" width="150">Наші телефони</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td class="adress"><!--Мобільний: --></td>
    <td class="adress"><!--(095) 567-70-55 --></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td background="images/img__61.gif" height="18px">&nbsp;</td>
  ...
  <tr>
    ...
    <td style="padding-left:10px; font-weight:bold">Єлектронний зв'язок</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td style="padding-left:10px; font-weight:bold">Як нас знайти</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
